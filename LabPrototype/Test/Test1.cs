...
namespace LabPrototype.Test
{
    class Test1
    {
        public static Labirint GetLab1(SpriteBatch spriteBatch)
        {
            ...
            Vector2 playerPosition = new Vector2((Const.SizeRoom + Const.SizeRoom / 2) * Const.SizeCell, (Const.SizeRoom + Const.SizeRoom / 2) * Const.SizeCell);
            //Vector2 playerPosition = new Vector2(Const.SizeRoom * Const.SizeCell, Const.SizeRoom * Const.SizeCell);
            ...
            lab.labirintLogic[1, 1] = GenerateLogic.GenerateRoom(spriteBatch, 1, 1);
            ...
            for (int i = 0; i < 0; ++i)
            {
             ...
             for (int i = 0; i < 0; ++i)
            {
                var a = new FirstItem(spriteBatch, new Vector2(rnd.Next(Const.SizeRoom * Const.SizeCell, Const.SizeRoom * 2 * Const.SizeCell), rnd.Next(Const.SizeRoom * Const.SizeCell, Const.SizeRoom * 2 * Const.SizeCell)));
                a.Speed = rnd.Next(2, 4);
                a.constants.collisionRadius = 14;
